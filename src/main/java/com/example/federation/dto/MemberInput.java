...
public class MemberInput {
    ...
    private List<SponsorReference> parrains;
    ...
    public List<SponsorReference> getParrains() { return parrains; }
    public void setParrains(List<SponsorReference> parrains) { this.parrains = parrains; }
}